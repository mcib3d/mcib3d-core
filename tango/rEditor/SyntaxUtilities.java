...
public class SyntaxUtilities {
	...
	public static SyntaxStyle[] getDefaultSyntaxStyles() {
		...
		styles[Token.COMMENT1] = new SyntaxStyle(Prefs.COMMENTColor, Prefs.COMMENT_IT, false);
		styles[Token.COMMENT2] = new SyntaxStyle(Prefs.COMMENTColor, Prefs.COMMENT_IT, false);
		styles[Token.KEYWORD1] = new SyntaxStyle(Prefs.KEYWORDColor, false, Prefs.KEYWORD_BOLD);
		styles[Token.KEYWORD2] = new SyntaxStyle(Prefs.OBJECTColor, Prefs.OBJECT_IT, false);
		styles[Token.KEYWORD3] = new SyntaxStyle(Color.darkGray, false, false); //not used?
		styles[Token.LITERAL1] = new SyntaxStyle(Prefs.QUOTEColor, false, false);
		styles[Token.LITERAL2] = new SyntaxStyle(Prefs.KEYWORDColor, false, true);
